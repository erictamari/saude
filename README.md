# 🩺 Minha Saúde – Sistema Pessoal de Gestão de Saúde

Aplicação web completa para gerenciar sua saúde: acompanhe especialidades, consultas, exames, agendamentos e resultados de exames de sangue com comparativos gráficos. Tudo armazenado localmente no seu navegador (localStorage).
...
- **Página de cada especialidade**:
  ...
  - Agendamento da próxima consulta com **contador regressivo** (atualiza automaticamente)
  - Recomendações personalizadas (o que melhorar, fazer e medicamentos)
- **Exames de Sangue**:
